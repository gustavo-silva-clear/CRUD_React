        ...
        {visivel === 'tabela' ? (
          ...
          <>
            <div className="flex justify-end">
              ...
              <Button cor="green" className="mb-4" onClick={() => setVisivel('form')}>Novo Cliente</Button>
          ...
          <Form client={clients[4]} clientChanged={saveClient} cancel={() => setVisivel('tabela')}></Form>
